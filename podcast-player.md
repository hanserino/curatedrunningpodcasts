...
<div class="latest-page__controls">
  {% include filter.html show_grid=false title="Filter episodes" noun="episode" filter_item=".latest-episodes__item" total_count=_unrelated_feed.size show_opml_favorites=false show_favorites_filter=false show_category_filters=false %}
</div>
